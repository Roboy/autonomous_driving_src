...
from geometry_msgs.msg import Vector3, Point as Point3D, Quaternion, Twist, PoseWithCovarianceStamped
...
def engine():
    ...
    def handle_velocity(twist):
        ...
        rospy.logdebug('Command(vel=%.2f, steering=%.2f) received', controls.vel, controls.steering)
        curr_time = time.time()
        global last_update
    ...
    rospy.Subscriber('initialpose', PoseWithCovarianceStamped, handle_initialpose, queue_size=1)
